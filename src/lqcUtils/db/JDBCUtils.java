 ...
 * JDBCUtils v3.0 使用连接池创建连接对象。连接对象可以是事务专用的连接对象，也可以是普通的连接对象。事务专用的连接对象用ThreadLocal存放
...
public class JDBCUtils {
	...
	static {
		System.setProperty("com.mchange.v2.c3p0.cfg.xml",JDBCUtils.class.getClassLoader().getResource("c3p0/c3p0-config.xml").getPath()); 
	}
