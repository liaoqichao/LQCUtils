 ...
 * Mail mail = new Mail("发件人","收件人","主题","内容(文本)");
 * AttachBean ab1 = new AttachBean(file,filename);	//新建附件对象1 可选
 * AttachBean ab2 = new AttachBean(file,filename);	//新建附件对象2 可选
 * mail.addAttach(ab1);	//添加附件1	可选
 * mail.addAttach(ab2);	//添加附件2	可选
 * mail.addCcAddress("abc@163.com,123@qq.com");//添加抄送	可选
 * mail.addBccAddress("mamamia@163.com,250@qq.com");//添加暗送	可选
